...
are examples of database platforms designed specifically for serverless
architecture.

### Example

One of the easiest ways you can take advantage of the Edge functions in
your React application is the new
[NextJS Middleware](https://nextjs.org/docs/advanced-features/middleware)
functions. Middlewares are deployed as Edge functions by default when
...
use code over configuration and run code close to your users on Vercel's
...
This middleware function would now run before all requests to our site. It
