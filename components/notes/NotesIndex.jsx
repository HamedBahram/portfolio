...
const NotesIndex = ({ notes }) => {
  ...
  return (
    <section>
      ...
      <div className="mb-8 flex items-center justify-between rounded-md bg-[#2b303b] py-1.5 pl-4 pr-2 focus-within:outline focus-within:outline-1 focus-within:outline-react-link dark:bg-[#282c34]">
        <input
          type="text"
