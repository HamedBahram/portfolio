...
const ProjectSummary = ({ title, summary, slug, icon }) => {
    return (
        <Link href={`/projects/${slug}`}>
            <a>
                <div className='flex justify-between items-center gap-4 px-5 py-4 mb-4 border border-gray-200 dark:border-gray-600 rounded hover:shadow-custom transition-shadow'>
                    <div className='p-3'>
                        {icon === 'reactjs' && (
                            <svg
                                aria-hidden='true'
