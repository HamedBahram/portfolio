            ...
            <ul className='flex justify-center gap-10 w-full'>
                <li>
                    <Link href='https://twitter.com/haamedbahram'>
                        <a
                            className='hover:text-react-link transition'
                            target='_blank'
                ...
                <li>
                    <Link href='https://www.linkedin.com/in/hamedbahram/'>
                        <a
                            className='hover:text-react-link transition'
                            target='_blank'
                            rel='noopener noreferrer'
                ...
                <li>
                    <Link href='https://github.com/HamedBahram'>
                        <a
                            className='hover:text-react-link transition'
                            target='_blank'
                            rel='noopener noreferrer'
                ...
                <li>
                    <Link href='https://m.me/haamedbahram'>
                        <a
                            className='hover:text-react-link transition'
                            target='_blank'
                            rel='noopener noreferrer'
